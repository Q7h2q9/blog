...
贴一下[使用x64dbg脱壳之开源壳upx](https://www.cnblogs.com/Chary/articles/14231600.html)的解释
...
在程序执行过程中，尤其是当函数调用发生时，ESP的值会发生变化，以反映栈上新的栈帧的创建。当函数返回时，ESP的值会恢复到函数调用之前的值，以保持栈的平衡。这就是**堆栈平衡定律**，也称**ESP定律**。
...
但是，做题过程中常常遇到UPX变种，出题人给exe加壳还修改了其他内容，比如UPX的标志位、overlay\_offset值等。此时upx工具不再有效，需要进行手动脱壳。
...
注意：如果遇到IAT表导入部分错误需要手动修复IAT表(造成无法运行等的错误)，参考文章：[通过x64dbg脚本功能修复IAT表](https://bbs.kanxue.com/thread-273896.htm)
...
[CTF中手工脱壳实例(UPX壳) | Reveone‘s Blog](https://www.reveone.cn/c9c2155d8c9c44899f99cfd6a63a98fc)

![image](https://gcore.jsdelivr.net/gh/Q7h2q9/photohouse/picgoandgithubimage-20250428101636-dsui752.png)

Helloctf上的讲解：

![image](https://gcore.jsdelivr.net/gh/Q7h2q9/photohouse/picgoandgithubimage-20250428101831-nfyss5b.png)
...
[【逆向】脱壳后修复IAT并关闭ASLR_iatxp-CSDN博客](https://blog.csdn.net/shipsail/article/details/105463063)

[使用x64dbg脱壳之开源壳upx - CharyGao - 博客园](https://www.cnblogs.com/Chary/articles/14231600.html)

[通过x64dbg脚本功能修复IAT表](https://bbs.kanxue.com/thread-273896.htm)
