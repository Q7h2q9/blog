...
[编译原理与技术（一）——编译器的整体结构_编译器架构-CSDN博客](https://blog.csdn.net/MCQSW/article/details/135970440)
...
[交叉编译&本地编译的区别_简述交叉编译器和普通编译器的本质区别是什么-CSDN博客](https://blog.csdn.net/Dream_And_Smlie/article/details/90411431)